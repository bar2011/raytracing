...
public:
    ...
    // CUSTOM:
    TimeInterval timeIntervalSinceDate(Date* other);
};
...
// CUSTOM:
_NS_INLINE NS::TimeInterval NS::Date::timeIntervalSinceDate(NS::Date* other)
{
    return NS::Object::sendMessage<NS::TimeInterval>(this, _NS_PRIVATE_SEL(timeIntervalSinceDate_), other);
}
